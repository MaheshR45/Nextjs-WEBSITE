            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="pricing_block">
                  <div className="icon">
                    <img alt="image" src="/libs/images/standard.png" />
                  </div>
                  ...
                  <a className="btn white_btn" href="#">BUY NOW</a>
                </div>
              </div>
              {/* pricing box 2 */}
              <div className="col-md-4">
                <div className="pricing_block highlited_block">
                  <div className="icon">
                    <img alt="image" src="/libs/images/unlimited.png" />
                  </div>
                  <div className="pkg_name">
                    <h3>Unlimited</h3>
              ...
              <div className="col-md-4">
                <div className="pricing_block">
                  <div className="icon">
                    <img alt="image" src="/libs/images/premium.png" />
                  </div>
                  <div className="pkg_name">
                    <h3>Premium</h3>
